...
export function DeskCard({
  ...
  const tone =
    employee.status === "ERROR" ? "var(--destructive)" : employee.accent;
  const statusTone = STATUS_TONE[employee.status];
  ...
  return (
    <article
      ...
      style={{
        ...
        boxShadow: linked
          ? `0 0 0 1px color-mix(in oklab, ${tone} 40%, transparent)`
          : undefined,
      }}
    >
      <div
      ...
      <p className="mt-1 line-clamp-2 text-[13px] text-foreground/90">
