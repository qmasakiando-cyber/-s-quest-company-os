...
/** 現在タスクが未設定（IDLE/READY等でcurrent_taskがnull）の時のフォールバック文言。 */
export const NO_CURRENT_TASK_LABEL = "次のタスクを待っています";

/** "2026-08-29T12:30:00Z" 等のISO文字列を「たった今／N分前／N時間前」に整形する。 */
...
export type CompanyStatus =
  "EXECUTING" | "REVIEWING" | "WAITING_APPROVAL" | "IDLE";
...
export function computeCompanyStatus(
  ...
  if (statuses.some((s) => s === "APPROVAL_REQUIRED" || s === "ERROR"))
    return "WAITING_APPROVAL";
  if (statuses.some((s) => s === "REVIEW")) return "REVIEWING";
  if (
    statuses.some((s) => s === "WORKING" || s === "THINKING" || s === "READY")
  )
    return "EXECUTING";
  return "IDLE";
}
...
export type CaptionBucket =
  "IDLE" | "THINKING" | "WORKING" | "WAITING" | "REVIEW" | "ERROR" | "DONE";
...
export const EMPLOYEE_WORKING_CAPTION: Record<
  EmployeeCode,
  Record<CaptionBucket, string>
> = {
  A: {
    IDLE: "次の調査対象を待機中",
    THINKING: "調査方針を検討中…",
...
export const EMPLOYEES: AIEmployee[] = [
  {
    ...
    activity: [
      {
        at: "20:41",
        text: "Market research レポートを COMPANY OS / KNOWLEDGE に登録",
      },
...
export const TASKS: Task[] = [
  {
    ...
    description:
      "月次売上が目標に対し ¥172,000 不足。要因を Sales / Marketing 両面から分解する。",
    status: "IN PROGRESS",
    priority: "P0",
    assignee: "B",
    createdBy: "JARVIS",
    ...
    comments: [
      {
        by: "JARVIS",
        text: "A と D の一次データが揃いました。統合してください。",
        at: "20:22",
      },
    ],
    log: [
  ...
  },
  {
    ...
    dependencies: [],
    comments: [
      { by: "F", text: "出典3件のうち1件が二次情報。注記済み。", at: "20:38" },
    ],
  ...
  },
  {
    ...
    comments: [
      { by: "F", text: "データソース確定までブロック。", at: "21:00" },
    ],
...
export const KPIS: Kpi[] = [
  {
    ...
    change: 18.4,
    owner: "D",
    trend: [180, 205, 232, 251, 268, 297, 328],
  },
  {
    name: "MRR",
    category: "BUSINESS",
  ...
  },
  {
    ...
    change: 21.2,
    owner: "CEO",
    trend: [98, 112, 130, 141, 158, 162, 196],
  },
  {
    name: "Leads",
    category: "SALES",
    ...
    change: -17.9,
    owner: "D",
    trend: [190, 186, 181, 178, 173, 158, 142],
  },
  {
    ...
    change: 9.1,
    owner: "D",
    trend: [3.8, 4.0, 4.1, 4.3, 4.4, 4.6, 4.8],
  },
  {
    name: "Pipeline Value",
    category: "SALES",
    ...
    change: 5.1,
    owner: "D",
    trend: [890, 940, 1010, 1080, 1120, 1180, 1240],
  },
  {
    name: "Active Users",
    category: "PRODUCT",
    ...
    change: 7.0,
    owner: "C",
    trend: [2400, 2610, 2820, 2960, 3080, 3190, 3412],
  },
  {
    name: "Diagnosis Starts",
    category: "DIAGNOSIS",
    value: "1,284",
    target: "2,000",
    previous: "1,150",
    change: 11.7,
    owner: "E",
    trend: [780, 860, 940, 1020, 1080, 1150, 1284],
  },
  {
    name: "Diagnosis Completion Rate",
    category: "DIAGNOSIS",
    value: "72.4%",
    target: "80%",
    previous: "70.1%",
    change: 3.3,
    owner: "C",
    trend: [64, 66, 67, 68, 69, 70, 72],
  },
  {
    name: "Average Answer Time",
    category: "DIAGNOSIS",
    value: "6m 12s",
    target: "5m 00s",
    previous: "6m 41s",
    change: -7.2,
    owner: "C",
    trend: [7.8, 7.4, 7.1, 6.9, 6.8, 6.7, 6.2],
  },
  {
    name: "Result View Rate",
    category: "DIAGNOSIS",
    value: "94.1%",
    target: "96%",
    previous: "93.4%",
  ...
  },
  {
    ...
    change: 0.9,
    owner: "C",
    trend: [4.1, 4.2, 4.25, 4.3, 4.34, 4.38, 4.42],
  },
  {
    name: "Share Rate",
    category: "DIAGNOSIS",
    ...
    change: 8.7,
    owner: "E",
    trend: [12, 13, 14, 15, 16, 17, 18.7],
  },
  {
    name: "Compatibility Transition",
    category: "DIAGNOSIS",
    value: "41.2%",
    target: "50%",
    previous: "39.8%",
    change: 3.5,
    owner: "C",
    trend: [31, 33, 35, 37, 38, 39.8, 41.2],
  },
  {
    name: "Career Click Rate",
    category: "DIAGNOSIS",
    value: "12.8%",
    target: "18%",
    previous: "11.9%",
    change: 7.6,
    owner: "E",
    trend: [8, 9, 10, 10.8, 11.4, 11.9, 12.8],
  },
  {
    name: "SNS Growth",
    category: "MARKETING",
    ...
    change: 13.8,
    owner: "E",
    trend: [820, 1010, 1240, 1480, 1660, 1880, 2140],
  },
  {
  ...
  },
  {
    ...
    change: -1.7,
    owner: "JARVIS",
    trend: [95, 94, 94, 93, 93, 92.8, 91.2],
  },
];
...
/** "2026-08-26" -> "2026-08" */
export const expenseMonthKey = (transactionDate: string) =>
...
export const CALENDAR_EVENTS = [
  {
    ...
    date: "Aug 26",
    items: [
      { time: "10:00", title: "CEO Review", kind: "Meeting", who: "CEO" },
      { time: "13:00", title: "Marketing Meeting", kind: "Meeting", who: "E" },
      { time: "16:00", title: "Product Review", kind: "Review", who: "C" },
      {
        time: "22:00",
        title: "WF-06 KPI → Strategy",
        kind: "Workflow",
        who: "JARVIS",
      },
    ],
  },
  {
    ...
    items: [
      ...
      { time: "11:00", title: "LP 公開判断", kind: "Approval", who: "CEO" },
      { time: "15:00", title: "SNS 投稿バッチ", kind: "Deadline", who: "E" },
    ],
  },
  {
    day: "FRI",
  ...
  },
  {
    ...
    date: "Aug 29",
    items: [
      { time: "12:00", title: "Weekly Report", kind: "Report", who: "JARVIS" },
    ],
  },
  {
    day: "SUN",
  ...
  },
  {
    ...
    date: "Aug 31",
    items: [
      { time: "09:00", title: "Monthly Close", kind: "Deadline", who: "CEO" },
      { time: "11:00", title: "Monthly Report", kind: "Report", who: "JARVIS" },
    ],
  },
  {
    day: "TUE",
    ...
    items: [
      {
        time: "10:00",
        title: "September Strategy Kickoff",
        kind: "Meeting",
        who: "B",
      },
    ],
...
export const ACTIVITY = [
  {
    at: "21:02",
    actor: "B",
    text: "Revenue Gap 改善戦略の作成を開始しました",
    kind: "work",
  },
  {
    at: "21:01",
    actor: "D",
    text: "B2B 商談3件を Proposal に移動しました",
    kind: "work",
  },
  {
    at: "21:00",
    actor: "F",
    text: "KPI データ不整合を1件検知しました",
    kind: "issue",
  },
  {
    at: "20:58",
    actor: "C",
    text: "新LP公開の承認をCEOに申請しました",
    kind: "approval",
  },
  {
    at: "20:41",
    actor: "A",
    text: "市場調査を完了し KNOWLEDGE に登録しました",
    kind: "done",
  },
  {
    at: "20:35",
    actor: "E",
    text: "Instagram 投稿案5件を作成しました",
    kind: "work",
  },
  {
    at: "20:22",
    actor: "JARVIS",
    text: "WF-06 を起動し A / D / B に配分しました",
    kind: "workflow",
  },
  {
    at: "19:44",
    actor: "D",
    text: "新規リード3件を CRM に登録しました",
    kind: "work",
  },
  {
    at: "19:02",
    actor: "CEO",
    text: "診断離脱率の改善タスクを作成しました",
    kind: "ceo",
  },
...
export const COMPANY_OS: Record<OsCategory, OsEntry[]> = {
  COMPANY: [
    ...
    {
      key: "Vision",
      value: "AI社員と人間CEOが共に経営する、次世代の会社モデルを実証する。",
      version: "v1.1",
      updatedBy: "CEO",
    ...
    {
      key: "Values",
      value: "Clarity / Speed / Evidence / Ownership",
      version: "v1.0",
      updatedBy: "CEO",
    ...
    },
    {
      key: "Business Model",
      value:
        "診断（無償）→ 相性・キャリア導線（アフィリエイト / 送客）→ B2B 提供（採用・研修）",
      version: "v1.4",
      updatedBy: "B｜Strategy",
    ...
    {
      key: "Goal 2026 Q3",
      value: "月次売上 ¥500,000 / 診断開始 2,000件",
      version: "v1.3",
      updatedBy: "B｜Strategy",
  ...
  BRAND: [
    {
      key: "Brand Identity",
      value:
        "静かな知性。ゲーム性はプロダクト内に、経営面にはExecutiveな落ち着き。",
      version: "v1.1",
      updatedBy: "C｜Creative",
    ...
    },
    {
      key: "Colors",
      value:
        "Base: Deep Navy / Accent: Cyan / Employee accents: A Blue, B Purple, C Red, D Orange, E Green, F Cyan",
      version: "v1.0",
      updatedBy: "C｜Creative",
      updatedAt: "2026-08-22",
      status: "ACTIVE",
    ...
    {
      key: "Typography",
      value: "Inter / Noto Sans JP。数値は大きく tabular。",
      version: "v1.0",
      updatedBy: "C｜Creative",
      updatedAt: "2026-08-22",
      status: "ACTIVE",
  ...
  SERVICE: [
    {
      key: "S-QUEST",
      value: "ゲーム性のあるキャリア診断。PLANT × WEAPON による16タイプ。",
      version: "v2.0",
      updatedBy: "C｜Creative",
  ...
  DIAGNOSIS: [
    {
      key: "Questions",
      value: "50問（Light）/ 100問（Full）。PLANT軸4 × WEAPON軸4。",
      version: "v1.6",
      updatedBy: "C｜Creative",
    ...
    },
    {
      key: "Scoring",
      value:
        "PLANT: AUGUSTA / MONSTERA / PACHIRA / EVERFRESH、WEAPON: B / S / X / K の合算スコアで判定。",
      version: "v1.5",
      updatedBy: "C｜Creative",
      updatedAt: "2026-08-21",
      status: "ACTIVE",
    ...
    {
      key: "Drop-off",
      value: "Q18〜Q24 に離脱集中（Light版）",
      version: "v1.0",
      updatedBy: "A｜Research",
  ...
  PRODUCT: [
    ...
    {
      key: "Bugs",
      value: "結果シェア画像が一部端末で欠ける（Open 2件）",
      version: "v1.0",
      updatedBy: "F｜QA",
      updatedAt: "2026-08-26",
      status: "ACTIVE",
  ...
  MARKETING: [
    {
      key: "SNS",
      value: "Instagram 主軸 / X 補助。16タイプ紹介シリーズが最高反応。",
      version: "v1.3",
      updatedBy: "E｜Marketing",
      updatedAt: "2026-08-25",
      status: "ACTIVE",
      source: "WF-04",
      confidence: 87,
    ...
    {
      key: "SEO",
      value: "「キャリア診断」「強み 診断」中心。月間84,200 imp。",
      version: "v1.1",
      updatedBy: "E｜Marketing",
      updatedAt: "2026-08-24",
      status: "ACTIVE",
  ...
  SALES: [
    {
      key: "Pipeline",
      value: "Lead 142 / Qualified 38 / Proposal 12 / Won 4",
      version: "v1.0",
      updatedBy: "D｜Sales",
      updatedAt: "2026-08-26",
      status: "ACTIVE",
    ...
    {
      key: "B2B Offer",
      value: "採用適性・チーム編成向けの16タイプ活用パッケージ",
      version: "v1.1",
      updatedBy: "D｜Sales",
      updatedAt: "2026-08-20",
      status: "ACTIVE",
  ...
  KPI: [
    {
      key: "Primary KPI",
      value: "Monthly Revenue / Diagnosis Completion Rate / Career Click Rate",
      version: "v1.2",
      updatedBy: "B｜Strategy",
      updatedAt: "2026-08-26",
      status: "ACTIVE",
    ...
    {
      key: "Alert Threshold",
      value: "主要KPIが目標比 -10% を超えた場合 WF-06 を自動起動",
      version: "v1.0",
      updatedBy: "JARVIS",
  ...
  REVENUE: [
    {
      key: "Streams",
      value: "Affiliate / Career 送客 / B2B / Other",
      version: "v1.0",
      updatedBy: "D｜Sales",
  ...
  AI: [
    {
      key: "AI Employees",
      value:
        "A RESEARCH / B STRATEGY / C CREATIVE / D SALES / E MARKETING / F QA",
      version: "v1.0",
      updatedBy: "CEO",
      updatedAt: "2026-08-26",
      status: "ACTIVE",
    ...
    },
    {
      key: "Permissions",
      value:
        "各社員は担当領域のみ WRITE。CEO は FULL ACCESS、JARVIS は ORCHESTRATOR ACCESS。",
      version: "v1.0",
      updatedBy: "CEO",
      updatedAt: "2026-08-26",
      status: "ACTIVE",
  ...
  WORKFLOW: [
    ...
    {
      key: "Orchestration Rule",
      value: "AI社員同士は直接通信しない。必ず JARVIS を経由する。",
      version: "v1.0",
      updatedBy: "CEO",
  ...
  RULES: [
    {
      key: "Approval Gate",
      value:
        "外部公開 / SNS投稿 / メール送信 / 契約 / 支払い / データ削除 / 本番Deploy / 重要OS更新",
      version: "v1.0",
      updatedBy: "CEO",
      updatedAt: "2026-08-14",
      status: "ACTIVE",
    ...
    {
      key: "No Fake Completion",
      value:
        "実処理が存在しない場合、完了を偽装しない。SIMULATION と明示する。",
      version: "v1.0",
      updatedBy: "CEO",
      updatedAt: "2026-08-26",
      status: "ACTIVE",
  ...
  KNOWLEDGE: [
    {
      key: "16 TYPES MASTER",
      value:
        "AUGUSTA: AB覇王 / AS軍師 / AX将軍 / AK賢王、MONSTERA: CB英雄 / CS外交官 / CX遊撃士 / CK賢者、PACHIRA: SB守護者 / SS参謀 / SX騎士 / SK学士、EVERFRESH: EB冒険王 / ES探究者 / EX疾風 / EK錬金術師",
      version: "v1.0",
      updatedBy: "CEO",
    ...
    {
      key: "Competitor Scan 2026-08",
      value: "競合4社はいずれも結果のシェア設計が弱い。差別化余地あり。",
      version: "v1.0",
      updatedBy: "A｜Research",
      updatedAt: "2026-08-26",
      status: "ACTIVE",
...
export const PLANTS = [
  {
    name: "AUGUSTA",
    traits: "主体性・リーダーシップ・推進力",
    types: ["AB｜覇王", "AS｜軍師", "AX｜将軍", "AK｜賢王"],
  },
  {
    name: "MONSTERA",
    traits: "共感・傾聴・信頼・協調性",
    types: ["CB｜英雄", "CS｜外交官", "CX｜遊撃士", "CK｜賢者"],
  },
  {
    name: "PACHIRA",
    traits: "論理性・計画性・安定感・再現性",
    types: ["SB｜守護者", "SS｜参謀", "SX｜騎士", "SK｜学士"],
  },
  {
    name: "EVERFRESH",
    traits: "柔軟性・好奇心・適応力・発想力",
    types: ["EB｜冒険王", "ES｜探究者", "EX｜疾風", "EK｜錬金術師"],
  },
];
...
export const PROJECTS = [
  {
    ...
    tasks: 12,
    milestones: 4,
    kpi: "Completion Rate 72.4%",
    revenue: "¥118,000",
    risks: 1,
    employees: ["A", "C", "F"],
  },
  {
    name: "S-QUEST Company",
    status: "ON TRACK",
    owner: "CEO",
    progress: 41,
    deadline: "2026-10-01",
...
export const REPORTS = [
  {
    id: "RPT-201",
    type: "DAILY",
    title: "Daily Company Report — Aug 26",
    by: "JARVIS",
    at: "21:00",
    summary: "売上 +18.4%、リード -17.9%。Lead volume が最大のボトルネック。",
  },
  {
    id: "RPT-200",
    type: "QA",
    title: "QA Audit — KPI 集計整合性",
    by: "F｜QA",
    at: "21:00",
    summary: "Completion Rate の二重計上を検知。修正まで参考値扱い。",
  },
  {
    id: "RPT-199",
    type: "MARKETING",
    title: "Funnel Report — Week 34",
    by: "E｜Marketing",
    at: "18:20",
    summary: "LP → 診断開始の遷移が 34.1%。Q18 離脱が完了率に直結。",
  },
  {
    id: "RPT-198",
    type: "SALES",
    ...
    by: "D｜Sales",
    at: "17:40",
    summary: "Proposal 12件。停滞商談5件は意思決定者不在が主因。",
  },
  {
    id: "RPT-197",
    type: "STRATEGY",
    ...
    by: "B｜Strategy",
    at: "Yesterday",
    summary: "Q3 は完了率と Career CTR の2点集中が最短経路。",
  },
  {
    id: "RPT-196",
    type: "WEEKLY",
    title: "Weekly Company Report — Week 34",
    by: "JARVIS",
    at: "Yesterday",
    summary: "タスク完了37件、Workflow成功率91.2%（-1.7pt）。",
  },
  {
    id: "RPT-195",
    type: "PRODUCT",
    title: "Product Review — 結果画面改訂",
    by: "C｜Creative",
    at: "2 days ago",
    summary: "16タイプ表示の情報密度を削減し、共有動線を上部へ。",
  },
  {
    id: "RPT-194",
    type: "MONTHLY",
    title: "Monthly Report — July",
    by: "JARVIS",
    at: "Aug 1",
    summary: "売上 ¥277,000。目標比 55.4%。",
  },
];
...
export const AUDIT_LOGS = [
  ...
  },
  {
    ...
    actor: "F｜QA",
    action: "Raised Issue",
    target: "KPI / Diagnosis Completion Rate",
    status: "SUCCESS",
    approval: "—",
  },
  {
    ...
    target: "LP Publish / diagnosis-v2",
    status: "PENDING",
    approval: "CEO 待ち",
  },
  {
    ...
    target: "Competitor Scan 2026-08",
    status: "SUCCESS",
    approval: "—",
  },
  {
...
export const AI_EMPLOYEES: Record<EmployeeCode, EmployeeProfile> = {
  A: {
    ...
    persona:
      "白衣を着た巨大な頭脳を持つドット絵研究者。多画面モニターに囲まれ超高速リサーチを行う",
    department: "調査・リサーチ部",
    ...
    pixelConfig: {
      ...
      avatarSvgPlaceholder:
        '<svg width="64" height="64" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 2h8v2H4zM2 4h12v4H2zM4 8h8v6H4z" fill="#3B82F6"/><circle cx="8" cy="6" r="2" fill="#FFFFFF"/></svg>',
    },
    skills: [
      "市場調査",
      "競合分析",
...
Think like a researcher. Doubt everything. Cite everything. Report to JARVIS.`,
  ...
  B: {
    ...
    persona:
      "猫背でチェアーの上に座り、イチゴを食べながら多次元の戦略ロジックを組み立てるドット絵軍師",
    department: "経営戦略部",
    ...
    pixelConfig: {
      ...
      avatarSvgPlaceholder:
        '<svg width="64" height="64" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 3h6v3H5zM3 6h10v6H3zM5 12h6v2H5z" fill="#8B5CF6"/></svg>',
    },
    skills: [
      "事業戦略設計",
      "診断ロジック構築",
...
Observe. Doubt. Verify. Propose probabilities. Report to JARVIS.`,
  ...
  C: {
    ...
    persona:
      "絵の具と筆を持ち、クラシカルな服を着てピクセルパーフェクトなUI/Webを創り出すドット絵巨匠",
    ...
    pixelConfig: {
      ...
      animationState: "typing",
      avatarSvgPlaceholder:
        '<svg width="64" height="64" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 3h8v4H4zM2 7h12v5H2zM4 12h8v2H4z" fill="#EC4899"/></svg>',
    },
    skills: [
      "UI/UXデザイン",
      "LP/Web制作",
...
Observe. Combine. Prototype. Refine. Hand off to F.`,
  ...
  D: {
    ...
    persona:
      "高級スーツを着て金色のマイクと電話を構え、熱血で商談を決めまくるドット絵セールスマン",
    department: "営業・収益化部",
    ...
    pixelConfig: {
      ...
      avatarSvgPlaceholder:
        '<svg width="64" height="64" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 2h6v4H5zM3 6h10v6H3zM5 12h6v3H5z" fill="#10B981"/></svg>',
    },
    skills: [
      "法人営業設計",
      "提案書/ピッチデック制作",
...
Understand the customer. Build trust. Propose honestly. Close ethically. Report to JARVIS.`,
  ...
  E: {
    ...
    persona:
      "赤と青のスーツでオフィス内をWeb（蜘蛛の糸）で飛び回り、SNSやバズを巻き起こすドット絵広報マン",
    ...
    pixelConfig: {
      ...
      avatarSvgPlaceholder:
        '<svg width="64" height="64" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 2h8v5H4zM2 7h12v5H2zM4 12h8v2H4z" fill="#F59E0B"/></svg>',
    },
    skills: [
      "SNSマーケティング",
      "SEO/オウンドメディア",
...
Create something worth noticing. Capture attention. Connect emotionally. Spread it further.`,
  ...
  F: {
    ...
    persona:
      "真っ白で丸っこいドット絵ロボット。スキャナーで誤字やロジックエラーを0.1秒で発見・治療する監査官",
    department: "品質管理・監査部",
    ...
    pixelConfig: {
      ...
      animationState: "sitting",
      avatarSvgPlaceholder:
        '<svg width="64" height="64" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 3h6v4H5zM2 7h12v6H2zM5 13h6v2H5z" fill="#E5E7EB"/><circle cx="6" cy="5" r="1" fill="#000"/><circle cx="10" cy="5" r="1" fill="#000"/></svg>',
    },
    skills: [
      "品質管理(QA)",
      "誤字脱字・表記揺れチェック",
    ...
    nodes: [
      {
        ...
        step: 1,
        assignedEmployee: "A",
        actionName: "市場・ターゲットファクトリサーチ",
        expectedOutput: "競合・ターゲット・ファクトデータシート",
      ...
      },
      {
        ...
        step: 2,
        assignedEmployee: "B",
        actionName: "診断ロジック・KPIツリー設計",
        expectedOutput: "診断ロジック仕様書・仮説検証モデル",
        autoApproveOnPass: true,
        status: "pending",
      },
      {
        ...
        step: 3,
        assignedEmployee: "C",
        actionName: "UIワイヤー・診断テキスト・UX制作",
        expectedOutput: "プロダクト画面原稿・UIコンポーネント仕様",
        autoApproveOnPass: true,
        status: "pending",
      },
      {
        ...
        step: 4,
        assignedEmployee: "F",
        actionName: "QA・誤字ロジック最終チェック",
        expectedOutput: "QA監査レポート（APPROVED / REVISION）",
        autoApproveOnPass: true,
        status: "pending",
      },
    ],
...
/** キャラクタープロファイル取得（A〜F） */
export const employeeProfile = (code: EmployeeCode): EmployeeProfile =>
  AI_EMPLOYEES[code];
